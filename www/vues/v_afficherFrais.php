...
<form action="index.php?uc=validerFrais&action=corrigerFraisHorsForfaitReporterFHF" 
      method="post" role="form">
            ...
            <div class="panel panel-info">
                ...
                <input id="visiteur" name = "visiteur" type="hidden" value="$Visiteur2">
                <input id="mois" name="mois" type="hidden" value="$Mois2">
...
<br><br><br><br><br>
    ...
    <form action="index.php?uc=validerFrais&action=validModifFraisHorsForfait" 
      method="post" role="form">
